...
// ListDevices provides a mock function with given fields: ctx, skip, limit, filters, sort, hasGroup, groupName
func (_m *InventoryApp) ListDevices(ctx context.Context, skip int, limit int, filters []store.Filter, sort *store.Sort, hasGroup *bool, groupName string) ([]model.Device, error) {
